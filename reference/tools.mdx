...
| `get_reddit_ad_groups` | Read | List Reddit ad groups (budget, bid, pixel, targeting summary), optionally per campaign. |
...
| `update_reddit_ad_group` | Write | Draft changes to a Reddit ad group — budget, bid, schedule, targeting. |
| `update_reddit_campaign` | Write | Draft changes to a Reddit campaign — name, schedule, spend cap, and (CBO only) budget/bid. |
