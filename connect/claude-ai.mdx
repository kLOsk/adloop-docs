...
- claude.ai caches the connector's tool list. When AdLoop gains tools (a new integration like [Reddit Ads](/integrations/reddit-ads), a new toolset on your key), refresh it under **Settings → Connectors → AdLoop**; until then Claude reports that the tools "aren't exposed in this session".
