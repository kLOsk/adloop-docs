...
| `ads` | `developer_token` | — | Legacy, optional: API access belongs to your Cloud project since September 2026 |
| `ads` | `customer_id` | — | Default Ads customer ID (auto-discovered by the wizard) |
| `ads` | `login_customer_id` | — | Your MCC account ID, only with a Manager Account |
