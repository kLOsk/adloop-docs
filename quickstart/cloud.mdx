...
<Steps>
  <Step title="Create your account">
    Register at [getadloop.com](https://getadloop.com/register). The free plan covers one Ads account and one GA4 property and needs no credit card. [Pricing](https://getadloop.com/preise) if you need more.
  </Step>
  <Step title="Connect Google">
    ...
    [Reddit Ads](/integrations/reddit-ads) is connected separately afterwards under **Settings → Reddit Ads**.
